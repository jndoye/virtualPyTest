...
VirtualPyTest was built to meet test automation needs according to a philosophy outlined by the following three tenets:
   1.Test automation must be simple and elegant.
   2.You should be able to use the same code regardless of the    
     system under test.
   3.Do not reinvent the wheel! Use what is already there.
